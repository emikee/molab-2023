    ...
    var body: some View {
        GeometryReader { bounds in
            ZStack {
                ...
                .frame(height: isActive ? bounds.size.height * 1 : bounds.size.height, alignment: .center)
//                .shadow(color: .black.opacity(0.1), radius: isActive ? 20 : 0, x: 0, y: 0)
        ...
        .frame(width: isActive ? width * 1.02 : width, alignment: .center)
...
//source https://github.com/pratikg29/Custom-Slider-Control?ref=iosexample.com
