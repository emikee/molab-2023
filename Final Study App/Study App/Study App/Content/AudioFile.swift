...
var audiofiles = [
    //AudioFile(name:"BG Track", url:"bgMusic.mp3", audioMax: 0.7),
    AudioFile(name:"Rain", url:"rain.mp3", audioMax: 2),
    AudioFile(name:"Chatter", url:"talking.mp3", audioMax: 7),
    AudioFile(name:"Machine", url:"espressoMachine.mp3", audioMax: 1),
    AudioFile(name:"Birds", url:"morningBirds.mp3", audioMax: 3),
